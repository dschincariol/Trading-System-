...
MODEL_NAME = os.environ.get("CALIB_HEALTH_MODEL_NAME", "embed_regressor")
...
def main() -> None:
    ...
    try:
        ...
        if any_bad and bad_count >= MAX_BAD_COUNT:
            ...
            # also signal retraining to refresh calibration dataset
            try:
                from engine.strategy.training_hooks import schedule_retraining
                schedule_retraining(model_name=MODEL_NAME, reason="calib_collapse")
            except Exception:
                pass
