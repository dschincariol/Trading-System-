...
const VOICE_LLM_ENDPOINT = "/api/voice/ask";
...
async function _askLLMFallback(userText) {
  // If endpoint doesn’t exist, this fails fast & silent.
  try {
...
function _wirePushToTalk(btn) {
  ...
  btn.addEventListener("click", (e) => {
    // If already wired for hold, a click will also fire after touchend; ignore if touch
...
function wireVoiceUI() {
  ...
  setInterval(_critSpeakLoop, 2500);
}
